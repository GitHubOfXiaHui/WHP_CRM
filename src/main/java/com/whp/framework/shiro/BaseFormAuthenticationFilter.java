 ...
 * Filename:		com.wondersgroup.framework.shiro.BaseFormAuthenticationFilter.java
...
package com.whp.framework.shiro;
...
public class BaseFormAuthenticationFilter extends FormAuthenticationFilter {
    ...
    protected boolean onLoginSuccess(AuthenticationToken token, Subject subject,
		...
		if (!"XMLHttpRequest".equalsIgnoreCase(httpServletRequest.getHeader("X-Requested-With")) 
			...
			httpServletResponse.sendRedirect(httpServletRequest.getContextPath() + "/management/login/timeout/success");
		}
