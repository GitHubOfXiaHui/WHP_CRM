...
<%!
	public String tree(Organization org) {
		...
		for(Organization o : org.getChildren()) {
			buffer.append("<li><a href=\"javascript:\" onclick=\"$.bringBack({id:'" + o.getId() + "', code:'" + o.getCode() + "',parentName:'" + o.getParent().getName() + "',parentCode:'" + o.getParent().getCode() + "', name:'" + o.getName() + "'})\">" + o.getName() + "</a>" + "\n");
