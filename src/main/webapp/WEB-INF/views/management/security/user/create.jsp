...
<form method="post" action="${contextPath }/management/security/user/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	<div class="pageFormContent" layoutH="58">
		<p>
			<label>登录名称：</label>
			<input type="text" name="username" class="validate[required,maxSize[32]] required" size="20" maxlength="32"/>
		</p>
		<p>
			<label>真实名字：</label>
			<input type="text" name="realname" class="validate[required,maxSize[32]] required" size="20" maxlength="32"/>
		</p>		
		<p>
			<label>登录密码：</label>
		...
		<p>
			<label>关联组织：</label>	
			<input name="orgb" val="organization.code" value="" type="hidden"/>
