	...
	<div class="panelBar">
		<ul class="toolBar">
			<%-- <shiro:hasPermission name="Vehicle:save"> --%>
				<li class="approval1"><a iconClass="page_white_add" rel="pass" target="dialog" mask="true" width="500" height="500" href="${contextPath }/management/vehicle/applications/approval1/pass/{slt_uid}" title="通过申请"><span>通过申请</span></a></li>
			<%-- </shiro:hasPermission> --%>
			<%-- <shiro:hasPermission name="Vehicle:save"> --%>
				<li class="approval1"><a iconClass="page_white_add" rel="reject" target="dialog" mask="true" width="500" height="500" href="${contextPath }/management/vehicle/applications/approval1/reject/{slt_uid}" title="驳回申请"><span>驳回申请</span></a></li>
			<%-- </shiro:hasPermission> --%>
		</ul>
	</div>
