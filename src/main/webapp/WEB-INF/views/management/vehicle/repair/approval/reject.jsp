...
<form method="post" 
	action="${contextPath }/management/vehicle/applications/approval1/reject"
...
<div class="formBar">
	<ul>
			<li>
			<a class="buttonActive"  callback="closeDialogRefreshTab"  target="ajaxTodo" href="${contextPath }/management/register/regAccess/auditing/${entity.id}" title="是否确认审核?"><span>审核</span></a>
			</li>
			<li><div class="button"><div class="buttonContent"><button type="submit">驳回</button>
			</div></div></li>
