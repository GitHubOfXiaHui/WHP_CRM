...
<form method="post" id="insuranceCreateForm" action="${contextPath }/management/vehicle/insurance/create" class="required-validate pageForm"
	...
	<div class="pageFormContent" layoutH="97">
		...
		<p>
			<label>车辆型号：</label>
			<input type="text" name="type" value='${vehicle.license }' readonly="readonly" /> 
		</p>
		<p>
			<label>车辆配置：</label>
					...
					<table class="list nowrap itemDetail" addButton="添加" width="100%">
						<thead align="center">
							<tr>
								...
								<th type="text" name="insuranceList[#index#].insuranceCost" fieldClass="maxSize[64]] required" size="20">保险价格（元）</th>
								<th type="text" name="insuranceList[#index#].insuranceAmount" size="10" fieldClass="maxSize[64]]">保险额度（万元） </th>
